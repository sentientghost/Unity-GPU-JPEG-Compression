...
public class LinearScript : MonoBehaviour 
{
    ...
    // Function to take image from the screen (Used for Demo)
    public float[] CallTakeImage(int imageWidth, int imageHeight, Camera cameraObject, int cameraQuality, string imagePath)
    {
        ...
        // Create a texture in ARGB32 format with the specified width and height
    ...
    // Function to take image from the screen (Used for Testing)
