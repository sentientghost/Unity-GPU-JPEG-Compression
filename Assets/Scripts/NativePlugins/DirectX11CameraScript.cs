...
public class DirectX11CameraScript : MonoBehaviour
{
    // Editor Options
    ...
    bool SaveScreenJPG ()
    {
        ...
        if (apiCount == 0)
        {
            //Take image using the DirectX 11 script and save the image times
    ...
    string ProcessData()
    {
        ...
        string[] graphicsAPI = new string[1] {"d3d11"};
